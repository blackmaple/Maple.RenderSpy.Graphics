...
namespace Maple.RenderSpy.Graphics.DXGI.COM_DXGIAdapter
{
    ...
    {
        private readonly delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<IDXGIAdapterImp>, DXGI_ADAPTER_DESC*, int> _proc = (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<IDXGIAdapterImp>, DXGI_ADAPTER_DESC*, int>)ptr;
