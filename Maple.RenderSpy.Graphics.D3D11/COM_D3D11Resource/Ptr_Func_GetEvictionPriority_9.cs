...
namespace Maple.RenderSpy.Graphics.D3D11.COM_D3D11Resource
{
    ...
    {
        private readonly delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D11ResourceImp>, uint> _proc = (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D11ResourceImp>, uint>)ptr;
