...
namespace Maple.RenderSpy.Graphics.D3D11.COM_D3D11Device
{
    ...
    internal readonly unsafe struct Ptr_Func_CreateDepthStencilView_10(nint ptr) : Maple.Hook.Abstractions.IHookMethod
    {
        private readonly delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D11DeviceImp>, void*, UnsafeIn<D3D11_DEPTH_STENCIL_VIEW_DESC>, UnsafeOut<UnsafePtr>, HRESULT>
            _proc
            = (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D11DeviceImp>, void*, UnsafeIn<D3D11_DEPTH_STENCIL_VIEW_DESC>, UnsafeOut<UnsafePtr>, HRESULT>)ptr;
