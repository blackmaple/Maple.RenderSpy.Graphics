...
namespace Maple.RenderSpy.Graphics.D3D11.COM_D3D11Device
{
    ...
    internal readonly unsafe struct Ptr_Func_CreateTexture3D_6(nint ptr) : Maple.Hook.Abstractions.IHookMethod
    {
        private readonly delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D11DeviceImp>, UnsafeIn<D3D11_TEXTURE3D_DESC>, UnsafeIn<D3D11_SUBRESOURCE_DATA>, UnsafeOut<UnsafePtr>, HRESULT>
            _proc
            = (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<ID3D11DeviceImp>, UnsafeIn<D3D11_TEXTURE3D_DESC>, UnsafeIn<D3D11_SUBRESOURCE_DATA>, UnsafeOut<UnsafePtr>, HRESULT>)ptr;
