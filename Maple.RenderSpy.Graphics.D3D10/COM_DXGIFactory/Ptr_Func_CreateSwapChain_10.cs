...
namespace Maple.RenderSpy.Graphics.D3D10.COM_DXGIFactory
{
    ...
    {
        private readonly delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<IDXGIFactoryImp>, COM_PTR_IUNKNOWN<ID3D10DeviceImp>, UnsafeIn<DXGI_SWAP_CHAIN_DESC>, UnsafeOut<COM_PTR_IUNKNOWN<IDXGISwapChainImp>>, COM_HRESULT>
            _proc
            = (delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<IDXGIFactoryImp>, COM_PTR_IUNKNOWN<ID3D10DeviceImp>, UnsafeIn<DXGI_SWAP_CHAIN_DESC>, UnsafeOut<COM_PTR_IUNKNOWN<IDXGISwapChainImp>>, COM_HRESULT>)ptr;
