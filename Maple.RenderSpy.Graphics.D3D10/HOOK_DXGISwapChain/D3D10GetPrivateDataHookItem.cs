...
{
    internal class D3D10GetPrivateDataHookItem : HookItem<D3D10GetPrivateDataHookItem, Ptr_Func_GetPrivateData_5, Ptr_Func_GetPrivateData_5>, IGraphicsHookItem<D3D10GetPrivateDataHookItem>
    {
        ...
        public static D3D10GetPrivateDataHookItem Create(IHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
            if (!functionsProvider.TryGetGraphicsFunctions(MethodName, out var functionPtr))
            {
                return GraphicsException.Throw<D3D10GetPrivateDataHookItem>($"NOT FOUND {MethodName}");
            }
