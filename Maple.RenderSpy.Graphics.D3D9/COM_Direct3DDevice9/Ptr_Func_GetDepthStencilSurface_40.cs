...
namespace Maple.RenderSpy.Graphics.D3D9.COM_Direct3DDevice9
{
    ...
    internal readonly unsafe struct Ptr_Func_GetDepthStencilSurface_40(nint ptr): Maple.Hook.Abstractions.IHookMethod
    {
        ...
        public COM_HRESULT Invoke(COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> pThis, Maple.UnmanagedExtensions.UnsafeOut<nint> ppZStencilSurface) => _proc(pThis, ppZStencilSurface);
