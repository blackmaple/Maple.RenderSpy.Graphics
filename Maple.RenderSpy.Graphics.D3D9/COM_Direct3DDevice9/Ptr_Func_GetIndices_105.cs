...
namespace Maple.RenderSpy.Graphics.D3D9.COM_Direct3DDevice9
{
    ...
    internal readonly unsafe struct Ptr_Func_GetIndices_105(nint ptr): Maple.Hook.Abstractions.IHookMethod
    {
        ...
        public COM_HRESULT Invoke(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> pThis, Maple.UnmanagedExtensions.UnsafeOut<nint> ppIndexData) => _proc(pThis, ppIndexData);
