...
namespace Maple.RenderSpy.Graphics.D3D9.COM_Direct3DDevice9
{
    ...
    internal readonly unsafe struct Ptr_Func_SetTextureStageState_67(nint ptr): Maple.Hook.Abstractions.IHookMethod
    {
        ...
        public COM_HRESULT Invoke(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> pThis, uint Stage, global::Windows.Win32.Graphics.Direct3D9.D3DTEXTURESTAGESTATETYPE Type, uint Value) => _proc(pThis, Stage, Type, Value);
