...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9BeginSceneHookItem : HookItem<D3D9BeginSceneHookItem, Ptr_Func_BeginScene_41, Ptr_Func_BeginScene_41>, IHookItemFactory<D3D9BeginSceneHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, D3D9BeginSceneHookItem, COM_HRESULT>? SyncCallback { get; set; }
        ...
        public static D3D9BeginSceneHookItem Create(IHookFactory hookFactory, IRenderSpyGraphicsFunctionsProvider functionsProvider)
        {
            ...
            {
                return RenderSpyGraphicsException.Throw<D3D9BeginSceneHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_BeginScene(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this)
        {
