...
{
    internal class D3D9GetPixelShaderConstantFHookItem : HookItem<D3D9GetPixelShaderConstantFHookItem, Ptr_Func_GetPixelShaderConstantF_110, Ptr_Func_GetPixelShaderConstantF_110>, IHookItemFactory<D3D9GetPixelShaderConstantFHookItem>
    {
        ...
        private static COM_HRESULT Hook_GetPixelShaderConstantF(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, uint StartRegister, Maple.UnmanagedExtensions.UnsafeRef<float> pConstantData, uint Vector4fCount)
        {
