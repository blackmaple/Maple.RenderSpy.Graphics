...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9GetVertexShaderHookItem : HookItem<D3D9GetVertexShaderHookItem, Ptr_Func_GetVertexShader_93, Ptr_Func_GetVertexShader_93>, IGraphicsHookItem<D3D9GetVertexShaderHookItem>
    {
        ...
        public static D3D9GetVertexShaderHookItem Create(IHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        private static COM_HRESULT Hook_GetVertexShader(COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, UnsafeOut<nint> ppShader)
        {
