...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9SetIndicesHookItem : HookItem<D3D9SetIndicesHookItem, Ptr_Func_SetIndices_104, Ptr_Func_SetIndices_104>, IHookItemFactory<D3D9SetIndicesHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, nint, D3D9SetIndicesHookItem, COM_HRESULT>? SyncCallback { get; set; }
        ...
        public static D3D9SetIndicesHookItem Create(IHookFactory hookFactory, IRenderSpyGraphicsFunctionsProvider functionsProvider)
        {
            ...
            {
                return RenderSpyGraphicsException.Throw<D3D9SetIndicesHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_SetIndices(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, nint pIndexData)
        {
            if (D3D9SetIndicesHookItem.TryGet(out var hookItem))
            {
                if (hookItem.SyncCallback is not null)
                {
                    return hookItem.SyncCallback.Invoke(@this, pIndexData, hookItem);
                }
