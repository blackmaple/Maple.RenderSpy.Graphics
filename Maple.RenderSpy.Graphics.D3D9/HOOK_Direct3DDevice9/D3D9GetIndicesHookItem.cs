...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9GetIndicesHookItem : HookItem<D3D9GetIndicesHookItem, Ptr_Func_GetIndices_105, Ptr_Func_GetIndices_105>, IGraphicsHookItem<D3D9GetIndicesHookItem>
    {
        ...
        public static D3D9GetIndicesHookItem Create(IHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        private static COM_HRESULT Hook_GetIndices(COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, UnsafeOut<nint> ppIndexData)
        {
