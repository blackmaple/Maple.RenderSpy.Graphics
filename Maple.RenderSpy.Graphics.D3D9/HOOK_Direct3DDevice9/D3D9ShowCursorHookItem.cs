...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9ShowCursorHookItem : HookItem<D3D9ShowCursorHookItem, Ptr_Func_ShowCursor_12, Ptr_Func_ShowCursor_12>, IHookItemFactory<D3D9ShowCursorHookItem>
    {
        ...
        {
            delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, int, int>
                _proc = &Hook_ShowCursor;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall)])]
        private static int Hook_ShowCursor(COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, int bShow)
        {
