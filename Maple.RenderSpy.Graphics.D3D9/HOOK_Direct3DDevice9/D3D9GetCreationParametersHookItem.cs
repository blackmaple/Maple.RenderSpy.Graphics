...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9GetCreationParametersHookItem : HookItem<D3D9GetCreationParametersHookItem, Ptr_Func_GetCreationParameters_9, Ptr_Func_GetCreationParameters_9>, IHookItemFactory<D3D9GetCreationParametersHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, Maple.UnmanagedExtensions.UnsafeRef<global::Windows.Win32.Graphics.Direct3D9.D3DDEVICE_CREATION_PARAMETERS>, COM_HRESULT>? SyncCallback { get; set; }
        ...
        {
            delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, Maple.UnmanagedExtensions.UnsafeRef<global::Windows.Win32.Graphics.Direct3D9.D3DDEVICE_CREATION_PARAMETERS>, COM_HRESULT>
                _proc = &Hook_GetCreationParameters;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall)])]
        private static COM_HRESULT Hook_GetCreationParameters(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, Maple.UnmanagedExtensions.UnsafeRef<global::Windows.Win32.Graphics.Direct3D9.D3DDEVICE_CREATION_PARAMETERS> pParameters)
        {
