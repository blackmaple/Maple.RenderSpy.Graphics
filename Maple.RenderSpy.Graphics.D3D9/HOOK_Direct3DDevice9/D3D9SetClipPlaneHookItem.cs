...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9SetClipPlaneHookItem : HookItem<D3D9SetClipPlaneHookItem, Ptr_Func_SetClipPlane_55, Ptr_Func_SetClipPlane_55>, IHookItemFactory<D3D9SetClipPlaneHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, uint, Maple.UnmanagedExtensions.UnsafeRef<float>, COM_HRESULT>? SyncCallback { get; set; }
        ...
        {
            delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, uint, Maple.UnmanagedExtensions.UnsafeRef<float>, COM_HRESULT>
                _proc = &Hook_SetClipPlane;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall)])]
        private static COM_HRESULT Hook_SetClipPlane(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, uint Index, Maple.UnmanagedExtensions.UnsafeRef<float> pPlane)
        {
