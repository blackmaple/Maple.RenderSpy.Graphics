...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9GetDirect3DHookItem : HookItem<D3D9GetDirect3DHookItem, Ptr_Func_GetDirect3D_6, Ptr_Func_GetDirect3D_6>, IHookItemFactory<D3D9GetDirect3DHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, Maple.UnmanagedExtensions.UnsafeOut<nint>, COM_HRESULT>? SyncCallback { get; set; }
        ...
        public static D3D9GetDirect3DHookItem Create(IHookFactory hookFactory, IRenderSpyGraphicsFunctionsProvider functionsProvider)
        {
            ...
            {
                return RenderSpyGraphicsException.Throw<D3D9GetDirect3DHookItem>($"NOT FOUND {MethodName}");
            }
        ...
        private static COM_HRESULT Hook_GetDirect3D(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, Maple.UnmanagedExtensions.UnsafeOut<nint> ppDirect3D)
        {
