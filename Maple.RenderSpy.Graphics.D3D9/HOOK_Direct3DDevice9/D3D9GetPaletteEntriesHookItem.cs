...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9GetPaletteEntriesHookItem : HookItem<D3D9GetPaletteEntriesHookItem, Ptr_Func_GetPaletteEntries_72, Ptr_Func_GetPaletteEntries_72>, IGraphicsHookItem<D3D9GetPaletteEntriesHookItem>
    {
        ...
        public static D3D9GetPaletteEntriesHookItem Create(IHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        private static COM_HRESULT Hook_GetPaletteEntries(COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, uint PaletteNumber, UnsafeRef<global::Windows.Win32.Graphics.Gdi.PALETTEENTRY> pEntries)
        {
