...
{
    internal class D3D9GetPaletteEntriesHookItem : HookItem<Ptr_Func_GetPaletteEntries_72, Ptr_Func_GetPaletteEntries_72>, IHookItemFactory<D3D9GetPaletteEntriesHookItem>
    {
        public const string MethodName = Ptr_Func_GetPaletteEntries_72.Name;

        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, uint, nint, D3D9GetPaletteEntriesHookItem, COM_HRESULT>? SyncCallback { get; set; }
        ...
        private static COM_HRESULT Hook_GetPaletteEntries(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, uint PaletteNumber, nint pEntries)
        {
