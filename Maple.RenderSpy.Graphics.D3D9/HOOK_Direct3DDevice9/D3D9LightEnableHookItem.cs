...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9LightEnableHookItem : HookItem<D3D9LightEnableHookItem, Ptr_Func_LightEnable_53, Ptr_Func_LightEnable_53>, IHookItemFactory<D3D9LightEnableHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, uint, int, COM_HRESULT>? SyncCallback { get; set; }
        ...
        {
            delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, uint, int, COM_HRESULT>
                _proc = &Hook_LightEnable;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall)])]
        private static COM_HRESULT Hook_LightEnable(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, uint Index, int Enable)
        {
