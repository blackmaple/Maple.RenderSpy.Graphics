...
{
    internal class D3D9GetPixelShaderConstantBHookItem : HookItem<Ptr_Func_GetPixelShaderConstantB_114, Ptr_Func_GetPixelShaderConstantB_114>, IHookItemFactory<D3D9GetPixelShaderConstantBHookItem>
    {
        public const string MethodName = Ptr_Func_GetPixelShaderConstantB_114.Name;

        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, uint, nint, uint, D3D9GetPixelShaderConstantBHookItem, COM_HRESULT>? SyncCallback { get; set; }
        ...
        private static COM_HRESULT Hook_GetPixelShaderConstantB(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, uint StartRegister, nint pConstantData, uint BoolCount)
        {
