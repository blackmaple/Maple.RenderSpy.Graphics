...
{
    internal class D3D9GetLightHookItem : HookItem<Ptr_Func_GetLight_52, Ptr_Func_GetLight_52>, IHookItemFactory<D3D9GetLightHookItem>
    {
        public const string MethodName = Ptr_Func_GetLight_52.Name;

        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, uint, nint, D3D9GetLightHookItem, COM_HRESULT>? SyncCallback { get; set; }
        ...
        private static COM_HRESULT Hook_GetLight(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, uint Index, nint pLight)
        {
