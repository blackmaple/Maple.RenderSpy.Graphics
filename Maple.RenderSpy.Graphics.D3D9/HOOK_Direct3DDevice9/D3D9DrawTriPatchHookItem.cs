...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9DrawTriPatchHookItem : HookItem<D3D9DrawTriPatchHookItem, Ptr_Func_DrawTriPatch_116, Ptr_Func_DrawTriPatch_116>, IHookItemFactory<D3D9DrawTriPatchHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, uint, nint, nint, uint, nint, int>? SyncCallback { get; set; }
        ...
        private static int Hook_DrawTriPatch(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, uint Handle, nint pNumSegs, nint pTriPatchInfo, uint Flags, nint pTriangleFanIndices)
        {
            if (D3D9DrawTriPatchHookItem.TryGet(out var hookItem))
            {
                ...
                {
                    return hookItem.SyncCallback.Invoke(@this, Handle, pNumSegs, pTriPatchInfo, Flags, pTriangleFanIndices);
                }
