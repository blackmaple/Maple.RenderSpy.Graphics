...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9StretchRectHookItem : HookItem<D3D9StretchRectHookItem, Ptr_Func_StretchRect_34, Ptr_Func_StretchRect_34>, IGraphicsHookItem<D3D9StretchRectHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, nint, Maple.UnmanagedExtensions.UnsafeRef< RECT>, nint, Maple.UnmanagedExtensions.UnsafeRef< RECT>, D3DTEXTUREFILTERTYPE, COM_HRESULT>? SyncCallback { get; set; }
        ...
        {
            delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, nint, Maple.UnmanagedExtensions.UnsafeRef<RECT>, nint, Maple.UnmanagedExtensions.UnsafeRef<RECT>, D3DTEXTUREFILTERTYPE, COM_HRESULT>
                _proc = &Hook_StretchRect;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall)])]
        private static COM_HRESULT Hook_StretchRect(COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, nint pSourceSurface, Maple.UnmanagedExtensions.UnsafeRef<RECT> pSourceRect, nint pDestSurface, Maple.UnmanagedExtensions.UnsafeRef<RECT> pDestRect, D3DTEXTUREFILTERTYPE Filter)
        {
