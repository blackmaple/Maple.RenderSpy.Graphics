...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9GetFVFHookItem : HookItem<D3D9GetFVFHookItem, Ptr_Func_GetFVF_90, Ptr_Func_GetFVF_90>, IGraphicsHookItem<D3D9GetFVFHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, Maple.UnmanagedExtensions.UnsafeRef<int>, D3D9GetFVFHookItem, COM_HRESULT>? SyncCallback { get; set; }

        public static D3D9GetFVFHookItem Create(IHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        private static COM_HRESULT Hook_GetFVF(COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, Maple.UnmanagedExtensions.UnsafeRef<int> pFVF)
        {
