...
{
    internal class D3D9GetScissorRectHookItem : HookItem<Ptr_Func_GetScissorRect_76, Ptr_Func_GetScissorRect_76>, IHookItemFactory<D3D9GetScissorRectHookItem>
    {
        public const string MethodName = Ptr_Func_GetScissorRect_76.Name;

        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, nint, D3D9GetScissorRectHookItem, COM_HRESULT>? SyncCallback { get; set; }
        ...
        private static COM_HRESULT Hook_GetScissorRect(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, nint pRect)
        {
