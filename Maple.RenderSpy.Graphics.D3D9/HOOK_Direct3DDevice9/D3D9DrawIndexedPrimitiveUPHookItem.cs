...
{
    internal class D3D9DrawIndexedPrimitiveUPHookItem : HookItem<Ptr_Func_DrawIndexedPrimitiveUP_84, Ptr_Func_DrawIndexedPrimitiveUP_84>, IHookItemFactory<D3D9DrawIndexedPrimitiveUPHookItem>
    {
        public const string MethodName = Ptr_Func_DrawIndexedPrimitiveUP_84.Name;

        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, D3DPRIMITIVETYPE, uint, uint, uint, nint, uint, nint, D3D9DrawIndexedPrimitiveUPHookItem, int>? SyncCallback { get; set; }
        ...
        {
            delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, D3DPRIMITIVETYPE, uint, uint, uint, nint, uint, nint, int>
                _proc = &Hook_DrawIndexedPrimitiveUP;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall)])]
        private static int Hook_DrawIndexedPrimitiveUP(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, D3DPRIMITIVETYPE PrimitiveType, uint MinVertexIndex, uint NumVertices, uint PrimitiveCount, nint pIndexData, D3DFORMAT IndexDataFormat, nint pVertexStreamZeroData, uint VertexStreamZeroStride)
        {
