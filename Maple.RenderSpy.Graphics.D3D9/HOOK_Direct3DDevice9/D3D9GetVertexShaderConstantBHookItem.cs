...
{
    internal class D3D9GetVertexShaderConstantBHookItem : HookItem<D3D9GetVertexShaderConstantBHookItem, Ptr_Func_GetVertexShaderConstantB_99, Ptr_Func_GetVertexShaderConstantB_99>, IHookItemFactory<D3D9GetVertexShaderConstantBHookItem>
    {
        ...
        private static COM_HRESULT Hook_GetVertexShaderConstantB(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, uint StartRegister, Maple.UnmanagedExtensions.UnsafeRef<global::Windows.Win32.Foundation.BOOL> pConstantData, uint BoolCount)
        {
