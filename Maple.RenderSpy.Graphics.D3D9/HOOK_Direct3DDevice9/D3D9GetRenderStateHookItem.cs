...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9GetRenderStateHookItem : HookItem<D3D9GetRenderStateHookItem, Ptr_Func_GetRenderState_58, Ptr_Func_GetRenderState_58>, IGraphicsHookItem<D3D9GetRenderStateHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, D3DRENDERSTATETYPE, Maple.UnmanagedExtensions.UnsafeRef<int>, COM_HRESULT>? SyncCallback { get; set; }

        public static D3D9GetRenderStateHookItem Create(IHookFactory hookFactory, GraphicsFunctionsProvider functionsProvider)
        {
        ...
        {
            delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<IDirect3DDevice9Imp>, D3DRENDERSTATETYPE, Maple.UnmanagedExtensions.UnsafeRef<int>, COM_HRESULT>
                _proc = &Hook_GetRenderState;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall)])]
        private static COM_HRESULT Hook_GetRenderState(COM_PTR_IUNKNOWN<IDirect3DDevice9Imp> @this, D3DRENDERSTATETYPE State, Maple.UnmanagedExtensions.UnsafeRef<int> pValue)
        {
