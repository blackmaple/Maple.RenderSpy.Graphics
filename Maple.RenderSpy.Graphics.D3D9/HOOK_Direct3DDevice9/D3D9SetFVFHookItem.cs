...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9SetFVFHookItem : HookItem<D3D9SetFVFHookItem, Ptr_Func_SetFVF_89, Ptr_Func_SetFVF_89>, IHookItemFactory<D3D9SetFVFHookItem>
    {
        ...
        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, uint, D3D9SetFVFHookItem, int>? SyncCallback { get; set; }
        ...
        private static int Hook_SetFVF(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, uint FVF)
        {
            if (D3D9SetFVFHookItem.TryGet(out var hookItem))
            {
                if (hookItem.SyncCallback is not null)
                {
                    return hookItem.SyncCallback.Invoke(@this, FVF, hookItem);
                }
