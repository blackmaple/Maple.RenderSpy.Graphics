...
{
    internal class D3D9GetNPatchModeHookItem : HookItem<D3D9GetNPatchModeHookItem, Ptr_Func_GetNPatchMode_80, Ptr_Func_GetNPatchMode_80>, IHookItemFactory<D3D9GetNPatchModeHookItem>
    {
        public const string MethodName = Ptr_Func_GetNPatchMode_80.Name;

        public Func<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, float>? SyncCallback { get; set; }
