...
namespace Maple.RenderSpy.Graphics.D3D9.HOOK_Direct3DDevice9
{
    internal class D3D9DrawPrimitiveHookItem : HookItem<D3D9DrawPrimitiveHookItem, Ptr_Func_DrawPrimitive_81, Ptr_Func_DrawPrimitive_81>, IHookItemFactory<D3D9DrawPrimitiveHookItem>
    {
        ...
        {
            delegate* unmanaged[Stdcall]<COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9>, D3DPRIMITIVETYPE, uint, uint, COM_HRESULT>
                _proc = &Hook_DrawPrimitive;
            return new(_proc);
        }

        [UnmanagedCallersOnly(CallConvs = [typeof(CallConvStdcall)])]
        private static COM_HRESULT Hook_DrawPrimitive(COM_PTR_IUNKNOWN<COM_INTERFACE_Direct3DDevice9> @this, D3DPRIMITIVETYPE PrimitiveType, uint StartVertex, uint PrimitiveCount)
        {
